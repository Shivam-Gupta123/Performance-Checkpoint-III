...
void hitLever(int cLever) // This function hits the correct lever
{
    ...
    else if(cLever == 1) // Lever A1
    {
        ...
        //No need to turn, just flip the lever now
        arm_servo.SetDegree(60);
...
{  
    ...
    // Rotate like 45 degrees to the left
    turnDegree(0, 50);
    ...
    // Drive backwards a bit and turn
    drive(0,30,7);
    turnDegreeCenter(0,90);
    drive(0,30,2);


    // Hit the correct lever
    hitLever(cLever);
}
